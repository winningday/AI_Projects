...
/// Very fast and accurate. Requires a Deepgram API key.
final class DeepgramClient {
    ...
    func transcribe(
        ...
        guard let apiKey = ConfigManager.shared.deepgramAPIKey, !apiKey.isEmpty else {
        ...
        // Add dictionary words as keywords to boost recognition
