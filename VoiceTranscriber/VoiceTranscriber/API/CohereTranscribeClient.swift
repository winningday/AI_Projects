...
final class CohereTranscribeClient {
    ...
    func transcribe(
        ...
        guard let apiKey = ConfigManager.shared.cohereAPIKey, !apiKey.isEmpty else {
    ...
    /// For a typical 5-30s recording, this takes <100ms.
